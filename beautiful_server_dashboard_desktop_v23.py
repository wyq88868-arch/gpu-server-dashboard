...
<head>
  ...
  <title>Server Resource Dashboard V2.3</title>
  <style>
    :root {
      --bg1: #eef7ff;
      --bg2: #f7f2ff;
  ...
  <main class="app">
    <div class="topbar">
      <div class="brand">
        ...
        <div>
          <h1>Server Resource Dashboard V2.3</h1>
          <div class="subtitle">V2.3 · Incremental DOM update · stable smooth scrolling</div>
        </div>
      </div>
      <div class="controls">
